...
def register():
    ...
    ID and first name in session, and redirects to the tv_shows.

    Returns:
        Redirect: Redirects to the tv_shows page if registration is successful, or the
...
def login():
    ...
    Returns:
        Redirect: Redirects to the tv_shows page if successful, or the login_page route if the
